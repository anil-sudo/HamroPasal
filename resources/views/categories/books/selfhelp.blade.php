...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 py-4 text-sm text-gray-600">
        ...
        <span class="mx-2">/</span>
        <span class="text-black font-medium">Self Help</span>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <h1 class="text-3xl font-bold">Self Help Books</h1>
        <p class="text-gray-600 mt-1">
            Improve mindset, productivity & personal growth
        </p>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-8 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm h-fit">
            ...
            <div class="space-y-4 text-sm">
                ...
                {{-- Category --}}
                <div>
                    <p class="font-medium mb-1">Category</p>
        ...
        <div class="lg:col-span-3">
            ...
            <h2 class="text-xl font-semibold mb-4">All Self Help Books</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-sm group">
                    ...
                    <img src="https://source.unsplash.com/400x500/?selfhelp,book,motivation,{{ $i }}"
