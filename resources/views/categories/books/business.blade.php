...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 py-4 text-sm text-gray-600">
        ...
        <span class="mx-2">/</span>
        <span class="text-black font-medium">Business</span>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <h1 class="text-3xl font-bold">Business Books</h1>
        <p class="text-gray-600 mt-1">
            Learn entrepreneurship, finance, marketing & leadership
        </p>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-8 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3">
            ...
            <h2 class="text-xl font-semibold mb-4">All Business Books</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-sm group">
                    ...
                    <img src="https://source.unsplash.com/400x500/?business,book,finance,{{ $i }}"
