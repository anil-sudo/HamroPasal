...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 py-4 text-sm text-gray-600">
        ...
        <span class="mx-2">/</span>
        <span class="text-black font-medium">Football</span>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <h1 class="text-3xl font-bold">Football Gear</h1>
        <p class="text-gray-600 mt-1">
            Jerseys, boots, balls & accessories for football lovers
        </p>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-8 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3">
            ...
            <h2 class="text-xl font-semibold mb-4">All Football Products</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-sm group">
                    ...
                    <img src="https://source.unsplash.com/400x400/?football,gear,{{ $i }}"
