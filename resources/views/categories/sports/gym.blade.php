...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 py-4 text-sm text-gray-600">
        ...
        <span class="mx-2">/</span>
        <span class="text-black font-medium">Gym</span>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <h1 class="text-3xl font-bold">Gym & Fitness</h1>
        <p class="text-gray-600 mt-1">
            Equipment, apparel & accessories for your fitness journey
        </p>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-8 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white p-5 rounded-xl shadow-sm h-fit">
            ...
            <div class="space-y-4 text-sm">
                ...
                {{-- Weight --}}
                <div>
                    <p class="font-medium mb-1">Weight</p>
                    <div class="flex flex-wrap gap-2">
                        @foreach(['5kg','10kg','20kg','50kg'] as $weight)
        ...
        <div class="lg:col-span-3">
            ...
            <h2 class="text-xl font-semibold mb-4">All Gym Products</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-sm group">
                    ...
                    <img src="https://source.unsplash.com/400x400/?gym,fitness,{{ $i }}"
