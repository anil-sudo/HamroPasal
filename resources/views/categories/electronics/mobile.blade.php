...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 py-4 text-sm text-gray-600">
        ...
        <span class="mx-2">/</span>
        <span class="text-black font-medium">Mobile</span>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <h1 class="text-3xl font-bold">Smartphones</h1>
        <p class="text-gray-600 mt-1">
            Discover latest mobile phones with best prices & features
        </p>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 mt-8 grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="space-y-4 text-sm">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach(['4GB','6GB','8GB','12GB'] as $ram)
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach(['64GB','128GB','256GB'] as $storage)
                            <span class="px-3 py-1 border rounded hover:bg-black hover:text-white cursor-pointer">
                                {{ $storage }}
                            </span>
                        @endforeach
        ...
        <div class="lg:col-span-3">
            ...
            <h2 class="text-xl font-semibold mb-4">All Mobile Phones</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg overflow-hidden shadow-sm group">
                    ...
                    <img src="https://source.unsplash.com/400x400/?smartphone,{{ $i }}"
